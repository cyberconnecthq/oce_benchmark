...
wsteth_contract = w3.eth.contract(address=WSTETH, abi=ERC20_ABI)
...
async def get_balances():
    ...
    # Get Lido contract WETH balance
    ...
    result = (
        ...
        f"{wsteth_balance / 1e18:.6f} stWETH\n\n"
    )
    ...
    result += (
        f"Lido Contract Info:\n"
        f"Lido WETH Balance: {lido_weth_balance / 1e18:.6f} WETH\n"
    )
