...
from dataset.constants import WETH_CONTRACT_ADDRESS_ETH
...
async def get_balances():
    # Query WETH allowance of addr to Uniswap V3 Router
    allowance = weth_contract.functions.allowance(addr, UNISWAP_V3_ROUTER).call()
    return (
        f"WETH allowance to Uniswap V3 Router (address: {addr}):\n"
